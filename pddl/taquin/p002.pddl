...
(define (problem taquin-3x3)
  ...
  (:init
     ;; configuration : un puzzle « facile », blank au centre
     (at tile1 p11) (at tile2 p12) (at tile3 p13)
     (at tile4 p21) (at blank p22) (at tile5 p23)
     (at tile6 p31) (at tile7 p32) (at tile8 p33)
     (empty p22)

     ;; --- relations d’adjacence horizontales ---
     ...
     ;; --- relations d’adjacence verticales ---
